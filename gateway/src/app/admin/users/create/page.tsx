    ...
    <div className="mx-auto w-full max-w-4xl px-6 py-8">
      <header className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Admin management</p>
        </div>
        <div className="flex items-center gap-3">
          <Link href="/admin/users" className="rounded-lg border border-border px-4 py-2 text-sm">
            Back to Users
          </Link>
        </div>
      </header>
      ...
      <div className="rounded-2xl border border-border bg-card p-4">
        <form className="space-y-3" onSubmit={onCreateUser}>
          ...
          {createSuccess ? <p className="text-sm text-primary">{createSuccess}</p> : null}

          <button
            type="submit"
            className="rounded-lg bg-primary px-4 py-2 text-primary-foreground disabled:cursor-not-allowed disabled:opacity-70"
            disabled={creating}
          >
